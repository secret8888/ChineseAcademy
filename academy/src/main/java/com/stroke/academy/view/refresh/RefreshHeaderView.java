...
/**
 * The header view for {@link com.partner.view.refresh.RefreshListView} and
 * {@link com.partner.view.refresh.RefreshScrollView}
 *
 * @author markmjw
 * @date 2013-10-08
 */
public class RefreshHeaderView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.view_refresh_header, null);
